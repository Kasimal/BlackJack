...
class DeckTest(unittest.TestCase):
    ...
    def test_calculate_bust_probability(self):
        ...
        bust_probability = deck.calculate_bust_probability(cards_5_7)
        ...
        bust_probability = deck.calculate_bust_probability(cards_3_8)
        ...
        bust_probability = deck.calculate_bust_probability(cards_2_9_10)
        ...
        bust_probability = deck.calculate_bust_probability(cards_10_10)
